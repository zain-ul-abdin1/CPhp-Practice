...
<main>
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <form class="mt-6 inline-flex justify-center rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" method="POST" action="/note">
      <input type="hidden" name="_method" value="DELETE">
      <input type="hidden" name="id" value=<?= $note["id"] ?>>
      <button class="text-s text-white-500">Delete</button>
    </form>
  </div>
</main>
